...
const SearchInputComponent = ({ response, resetSuggestSearchQueries, query: queryProp, selectedSmartFAQ, saveSelectedSmartFAQ }) => {
  ...
  const handleInputFocus = () => {
   ...
   const handleInputChange = e => {
      ...
      // console.log(dropdownShown,currentInput.length)
      
      // triggerSearch(currentInput);
         ...
         <VoiceContext.Consumer>
            {  
               value => {
                  ...
                  const voiceSearchEnabledPlaceholder = recording ? 'Listening...' : "Find what you're looking for";
                     ...
                     <>
                        <div className="input-wrapper">
                           ...
                           <button className="search-btn" aria-label="Search button" onClick={() => triggerSearch(query)}>
                              ...
                              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="searchTopper-module__search-icon___280TE"><circle cx="13" cy="9" r="7.5" stroke="currentColor" stroke-width="3"></circle><path d="M2 20L7 15" stroke="currentColor" stroke-width="3"></path></svg>
                           </button>
